        ...
        <footer class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center justify-between py-8">
                <p class="opacity-40 text-xs mb-2 sm:mb-0">
                    Copyright © 2023 Robolab LLC. All rights reserved.
                </p>

                <div class="items-center opacity-40 sm:mt-0 text-xs flex gap-8">
                    <RouterLink to="/terms">Terms</RouterLink>
                    <RouterLink to="/privacy">Privacy</RouterLink>
                    <a class="ml-auto flex justify-center items-center w-6 h-6 text-[var(--app-fore11)]"
                        href="https://github.com/robolab-io/mechakeys-app" aria-label="github" target="_blank"
                        rel="noopener"><svg class="w-4 h-4 fill-current" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="flex justify-center items-center w-6 h-6 text-[var(--app-fore11)]"
                        href="https://discord.robolab.io" aria-label="github" target="_blank" rel="noopener"><svg
                            class="w-4 h-4 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <title>Discord</title>
                            <path
