        ...
        <div class="mx-auto max-w-7xl py-8 lg:py-10 px-8 sm:px-10 lg:px-12">
            <nav class="relative flex justify-between items-center">
                ...
                <div class="gap-8 items-center flex">
                    ...
                    <!-- <a class="justify-center items-center w-9 h-9 text-[var(--app-fore5)] hidden sm:flex"
                    ...
                    <RouterLink class="flex items-center" to="/branding">
                        <div class="hidden sm:block font-bold text-sm">Branding</div>
                    </RouterLink>
                    <RouterLink class="flex items-center" to="/changelog">
                        <div class="hidden sm:block font-bold text-sm">Changelog</div>
                    </RouterLink>
