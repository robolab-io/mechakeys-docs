      ...
      <ul role="list"
        ...
        <li>
          <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
            <li>
              <figure class="relative rounded-2xl bg-[var(--app-base2)] p-6 shadow-2xl border-solid border-[1px] border-[var(--borders-base1)]"><svg aria-hidden="true"
          ...
          <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
            <li>
              <figure class="relative rounded-2xl bg-[var(--app-base2)] p-6 shadow-2xl border-solid border-[1px] border-[var(--borders-base1)]"><svg aria-hidden="true"
                ...
                <blockquote class="relative overflow-hidden aspect-video">
                  <iframe class="absolute inset-0 w-full h-full" width="560" height="315" src="https://www.youtube.com/embed/5qOMPkvpo90?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </blockquote>
                <figcaption class="relative mt-6 flex items-center justify-between pt-6">
                  <div>
            ...
            <li>
              <figure class="relative rounded-2xl bg-[var(--app-base2)] p-6 shadow-2xl border-solid border-[1px] border-[var(--borders-base1)]"><svg aria-hidden="true"
                ...
                <blockquote class="relative overflow-hidden aspect-video">
                  <iframe class="absolute inset-0 w-full h-full" width="560" height="315" src="https://www.youtube.com/embed/tPFySY0IEsY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </blockquote>
                <figcaption class="relative mt-6 flex items-center justify-between pt-6">
                  <div>
          ...
          <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
            <li>
              <figure class="relative rounded-2xl bg-[var(--app-base2)] p-6 shadow-2xl border-solid border-[1px] border-[var(--borders-base1)]"><svg aria-hidden="true"
                ...
                <blockquote class="relative">
                  <p class="text-lg tracking-tight text-slate-300">mechakeys was the goat before i had a mechanical kb</p>
                </blockquote>
                <figcaption class="relative mt-6 flex items-center justify-between pt-6">
                  <div>
